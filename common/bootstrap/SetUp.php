...
use shop\entities\User\events\UserSignUpPassword;
...
use shop\listeners\User\UserSignupPasswordListener;
...
class SetUp implements BootstrapInterface
{
   public function bootstrap($app)
   {
     ...
     /* $container->setSingleton(ludan::class,function (){
          return new ludan(new vova(new yyyy()));
      });*/
