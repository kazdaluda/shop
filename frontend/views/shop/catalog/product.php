...
<div class="row" xmlns:fb="http://www.w3.org/1999/xhtml">
    <div class="col-sm-8">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-review" data-toggle="tab">Reviews (<?= $product->countReview() ?>)</a></li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-review">
                ...
                <?php foreach ($product->reviews as $i=> $review) :?>
                    <?php if ($review->active):?>
                    <div class="comment-item" data-id="<?= $product->id ?>">
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                    ...
                                    <div class="pull-right">
                                        <span class="comment-reply">Оценка <?= $review->vote ?></span>
                                    </div>
