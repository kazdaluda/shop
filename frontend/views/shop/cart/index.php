...
<div class="cabinet-index">
    ...
    <div class="buttons clearfix">
        <div class="pull-left"><a href="<?=Html::encode( Url::to('/catalog')) ?>" class="btn btn-default">Continue Shopping</a></div>
        <?php if ($cart->getItems()): ?>
            <div class="pull-right"><a href="<?= Url::to('/checkout'/*'/frontend/web/shop/checkout'*/) ?>" class="btn btn-primary">Checkout</a></div>
        <?php endif; ?>
    </div>
</div>
