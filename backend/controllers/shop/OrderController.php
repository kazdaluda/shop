    ...
    public function actionExport()
    {
        $query = Order::find()->orderBy(['id' => SORT_DESC]);
           ...
           // foreach ($orders as $row => $order) {
                ...
                $worksheet->setCellValueByColumnAndRow(2, $row + 1, $order->cost);
                $worksheet->setCellValueByColumnAndRow(3, $row + 1, $order->note);
                $worksheet->setCellValueByColumnAndRow(4, $row + 1, $order->customer_phone);
            }
