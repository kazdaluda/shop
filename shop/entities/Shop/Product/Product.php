...
use shop\jobs\Product\ProductAvailabilityNotification;
...
class Product extends ActiveRecord implements AggregateRoot
{
    ...
    private function setQuantity($quantity): void
    {
        if ($this->quantity == 0 && $quantity > 0) {
           ...
           // $this->recordEvent(new ProductAvailabilityNotification($this));
        }
    ...
    {
        return $this->hasMany(Review::class, ['product' => 'id']);
    }
